...
import coin from '../assets/logos/gif 1.png'
...
import zombie from '../assets/images/Zombie walk.png'
  ...
  return (
    <div className='relative'>
        <div className='WraperContainer w-full h-auto py-[150px] flex flex-row justify-center items-center gap-5'>
            <div className='text-white flex flex-col gap-10 md:w-[40%] w-screen'>
                <img src={BloodToken} alt=''/>
                <p className='ml-5'>Laborum laborum nisi quis et do non. Irure excepteur nostrud incididunt aute exercitation irure. 
                   Cillum ea non ullamco laboris dolor nostrud dolore pariatur tempor esse et ex exercitation adipisicing. 
                   Excepteur occaecat dolore Lorem incididunt anim. 
                </p>
        ...
        <div className='flex flex-row flex-wrap justify-center items-center w-full gap-[100px] bg-black'>
            <div className='md:w-[300px] w-[95%]'>
                <img src={zombie} alt=''/>
            </div>
            <div className='md:w-[45%] w-[95%] flex flex-col'>
                <h1>
                    <img src={heading} alt=''/>
                </h1>
