...
import Gost3333 from '../assets/images/Ghostface_Gif3 2.png'
import Group13333 from '../assets/images/Group (2).png'
import freddy3333 from '../assets/images/Freddy_pose1 2.png'
import Penny3333 from '../assets/images/Pennywise_pose1 2.png'
import PinHead3333 from '../assets/images/Pinhead_pose1 2.png'
import Leather3333 from '../assets/images/Leather-face_pose1 2.png'
import mike3333 from '../assets/images/mike-myers_pose1 2.png'
import jason3333 from '../assets/images/Jason_pose2 2 (2).png'
import chucky3333 from '../assets/images/Chucky_Pose3 3.png'
       ...
       <div className='flex flex-col gap-[30px] py-[50px]'>
          ...
          <div className='flex flex-row flex-wrap justify-center gap-[20px] w-full'>
            <div className='relative'>
              <img className='absolute bottom-[5px]' src={Gost3333} alt=''/>
              <img className='w-[120px]' src={Group13333} alt=''/>
            </div>
            <div className='relative'>
              <img className='absolute bottom-[2px] h-[170px] w-full' src={freddy3333} alt=''/>
              <img className='w-[120px]' src={Group13333} alt=''/>
            </div>
            <div className='relative'>
              <img className='absolute bottom-[5px]' src={Penny3333} alt=''/>
              <img className='w-[120px]' src={Group13333} alt=''/>
            </div>
            <div className='relative'>
              <img className='absolute bottom-[5px] rotate-next' src={PinHead3333} alt=''/>
              <img className='w-[120px]' src={Group13333} alt=''/>
            </div>
            <div className='relative'>
              <img className='absolute bottom-[5px] h-[125px]' src={Leather3333} alt=''/>
              <img className='w-[120px]' src={Group13333} alt=''/>
            </div>
            <div className='relative'>
              <img className='absolute bottom-[5px]' src={mike3333} alt=''/>
              <img className='w-[120px]' src={Group13333} alt=''/>
            </div>
            <div className='relative'>
              <img className='absolute bottom-[5px] h-[180px] w-full' src={jason3333} alt=''/>
              <img className='w-[120px]' src={Group13333} alt=''/>
            </div>
            <div className='relative'>
              <img className='absolute bottom-[5px]' src={chucky3333} alt=''/>
              <img className='w-[120px]' src={Group13333} alt=''/>
            </div>
          </div>
